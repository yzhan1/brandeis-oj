...
Course.create(course_code:"11a", course_title:"Intro to Programming", user_id: 8)
Course.create(course_code:"12b", course_title:"Advanced Programming Techniques", user_id: 6)
Course.create(course_code:"21a", course_title:"Data Structures and Algorithms", user_id: 7)
Course.create(course_code:"166b", course_title:"Capstone: Software Engineering", user_id: 6)
...
Enrollment.create(user_id:1, course_code:"11a", final_grade:100.0)
Enrollment.create(user_id:2, course_code:"11a", final_grade:100.0)
Enrollment.create(user_id:3, course_code:"12b", final_grade:100.0)
Enrollment.create(user_id:4, course_code:"21a", final_grade:100.0)
Enrollment.create(user_id:4, course_code:"166b", final_grade:100.0)
