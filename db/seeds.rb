...
Enrollment.create(student_id:1, course_id:1, final_grade:100.0)
Enrollment.create(student_id:2, course_id:1, final_grade:100.0)
Enrollment.create(student_id:3, course_id:2, final_grade:100.0)
Enrollment.create(student_id:4, course_id:3, final_grade:100.0)
Enrollment.create(student_id:4, course_id:4, final_grade:100.0)
